function jqplotToImg(objId) {
    ...
    newCanvas.width = $("#" + objId).width(), newCanvas.height = $("#" + objId).height();
    var baseOffset = $("#" + objId).offset();
    return $("#" + objId).children().each(function() {
        if ("div" == $(this)[0].tagName.toLowerCase()) $(this).children("canvas").each(function() {
            var offset = $(this).offset();
            newCanvas.getContext("2d").drawImage(this, offset.left - baseOffset.left, offset.top - baseOffset.top);
        }), $(this).children("div").each(function() {
            var offset = $(this).offset(), context = newCanvas.getContext("2d");
        ...
        var offset = $(this).offset(), context = newCanvas.getContext("2d");
        context.setFillColor($(this).css("background-color")), context.fillRect(offset.left - baseOffset.left, offset.top - baseOffset.top, 15, 15);
...
//# sourceMappingURL=exportImg.min.js.map