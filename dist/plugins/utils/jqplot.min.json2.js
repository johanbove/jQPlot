!function($) {
    ...
    $.jqplot.JSON = window.JSON, window.JSON || ($.jqplot.JSON = {}), "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function(key) {
    ...
    "function" != typeof $.jqplot.JSON.stringify && ($.jqplot.JSON.stringify = function(value, replacer, space) {
        var i;
        if (gap = "", indent = "", "number" == typeof space) for (i = 0; space > i; i += 1) indent += " "; else "string" == typeof space && (indent = space);
        if (rep = replacer, replacer && "function" != typeof replacer && ("object" != typeof replacer || "number" != typeof replacer.length)) throw new Error("$.jqplot.JSON.stringify");
        return str("", {
            "": value
        });
    }), "function" != typeof $.jqplot.JSON.parse && ($.jqplot.JSON.parse = function(text, reviver) {
...
//# sourceMappingURL=jqplot.min.json2.js.map